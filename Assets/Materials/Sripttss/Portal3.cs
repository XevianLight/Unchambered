...
public class Portal3 : MonoBehaviour
{
	...
	public Portal3 OtherPortal { get; private set; }
	...
	private List<PortalableObject3> portalObjects = new List<PortalableObject3>();
	...
	private void Start()
	{
		...
		var portalForward = transform.forward;
		...
		PlacePortal(null, transform.localPosition, transform.rotation);
	}
	...
	{
		var obj = other.GetComponent<PortalableObject3>();
		if (obj != null)
		{
